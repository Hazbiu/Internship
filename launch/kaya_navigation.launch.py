...
def generate_launch_description():
    ...
    map_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            get_package_share_directory("kaya_navigation"), "maps", "KayaMap.yaml"
        ),
    )
    ...
    param_dir = LaunchConfiguration(
        "params_file",
        default=os.path.join(
            get_package_share_directory("kaya_navigation"), "params", "kaya_nav2_params.yaml"
        ),
    )
    ...
    rviz_config_dir = os.path.join(get_package_share_directory("kaya_navigation"), "rviz2", "kaya_navigation.rviz")

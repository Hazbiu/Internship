...
def generate_launch_description():
    ...
    map_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            get_package_share_directory("carter_v1_navigation"), "maps", "Carter_ROS2_Sensors.yaml"
        ),
    )
    ...
    param_dir = LaunchConfiguration(
        "params_file",
        default=os.path.join(
            get_package_share_directory("carter_v1_navigation"), "params", "carter_v1_nav2_params.yaml"
        ),
    )
    ...
    rviz_config_dir = os.path.join(get_package_share_directory("carter_v1_navigation"), "rviz2", "carter_v1_navigation.rviz")
